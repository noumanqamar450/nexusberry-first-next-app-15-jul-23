...
const _error = __webpack_require__(2494);
...
const _uaparserjs = /*#__PURE__*/ _interop_require_default(__webpack_require__(7522));
...
const serverExports = {
    NextRequest: (__webpack_require__(6416).NextRequest),
    NextResponse: (__webpack_require__(8438).NextResponse),
    ImageResponse: (__webpack_require__(3167)/* .ImageResponse */ .E),
    userAgentFromString: (__webpack_require__(5425).userAgentFromString),
    userAgent: (__webpack_require__(5425).userAgent)
};
